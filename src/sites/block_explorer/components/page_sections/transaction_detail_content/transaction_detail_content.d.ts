 ...
 * Details content.
 */
export declare const TransactionDetailsContentPlaceholder: React.FC;
/**
 * TransactionDetailsContent represents the Tabular data of the
 * Transaction Details itself.
 */
export declare const TransactionDetailsContent: React.FC;
 ...
 */
export declare const TransactionDataContents: React.FC;
