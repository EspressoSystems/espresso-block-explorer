import { ActiveValidatorSetSnapshot } from '../../../../../../../../../../../src/service/espresso_l1_validator_service/validators_active/active_validator_set_snapshot';
import { default as React } from 'react';
/**
 * ActiveValidatorsContext provides a React Context
 * for the current active validator set snapshot.
 */
export declare const ActiveValidatorsContext: React.Context<ActiveValidatorSetSnapshot | null>;
/**
