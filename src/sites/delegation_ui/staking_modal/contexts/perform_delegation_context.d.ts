...
export declare const DelegateAsyncIterableContext: React.Context<AsyncIterable<PerformWriteTransactionState> | null>;
export declare const SetDelegationAsyncIterableContext: React.Context<React.Dispatch<React.SetStateAction<AsyncIterable<PerformWriteTransactionState> | null>>>;
export declare const DelegateAsyncSnapshotContext: React.Context<AsyncSnapshot<PerformWriteTransactionState>>;
