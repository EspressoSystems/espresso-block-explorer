 ...
 * **NOT** be attempted.
 */
export declare enum ShouldRetryResult {
    no = -1
}
/**
...
export type RetryControllerOption = (controller: RetryController) => RetryController;
export declare function createRetryController(controller: RetryController, ...options: RetryControllerOption[]): RetryController;
