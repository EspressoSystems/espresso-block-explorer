 ...
 */
export declare function encodeNumberIteratorToHexits(iterator: Iterator<number>): IterableIterator<string>;
/**
 * encodeNumberIterableToHexits will transform the Iterable of numbers into
 * its hex representation.
 */
export declare function encodeNumberIterableToHexits(iterable: Iterable<number>): IterableIterator<string>;
