 ...
 * to draw.
 */
export declare const RollUpsSummaryDataTablePlaceholder: React.FC<RollUpsSummaryDataTablePlaceholderProps>;
/**
 * RollUpsSummaryDataTable represents the Data Table for RollUps Summary
 * display when data is available.
 */
export declare const RollUpsSummaryDataTable: React.FC;
export {};
