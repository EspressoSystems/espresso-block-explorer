 ...
 * by the Espresso name.
 *
 * Its dimensions are 138 x 40.
 */
declare const EspressoLogoAndTitle: React.FC<EspressoLogoAndTitleProps>;
export default EspressoLogoAndTitle;
