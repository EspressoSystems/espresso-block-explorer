 ...
 * implementation.
 */
export declare class UnimplementedHotShotQueryService implements HotShotQueryService {
    readonly availability: UnimplementedHotShotQueryServiceAvailabilityAPI;
    readonly status: UnimplementedHotShotQueryServiceStatusAPI;
    readonly explorer: UnimplementedHotShotQueryServiceExplorerAPI;
    readonly rewardState: UnimplementedHotShotQueryServiceRewardStateAPI;
    readonly node: UnimplementedHotShotQueryServiceNodeAPI;
