...
export declare class LeafV1 {
    ...
    constructor(view_number: number, justify_qc: QuorumCertificateV1, parent_commitment: TaggedBase64, block_header: CappuccinoAPIHeader, upgrade_certificate: null | UpgradeCertificateV1, block_payload: CappuccinoAPIPayload);
    toJSON(): {
        view_number: number;
        justify_qc: {
            data: unknown;
