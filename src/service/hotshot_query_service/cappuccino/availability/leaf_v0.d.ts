...
export declare class LeafV0 {
    ...
    constructor(view_number: number, justify_qc: QuorumCertificateV1, parent_commitment: TaggedBase64, block_header: CappuccinoAPIHeader, block_payload: CappuccinoAPIPayload, rejected: number[], timestamp: number, proposer_id: ArrayBuffer);
    toJSON(): {
        view_number: number;
        justify_qc: {
            data: unknown;
