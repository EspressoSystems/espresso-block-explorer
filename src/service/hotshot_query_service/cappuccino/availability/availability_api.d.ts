 ...
 */
export interface CappuccinoHotShotQueryServiceAvailabilityAPI extends HotShotQueryServiceAvailabilityAPI<CappuccinoAPILeafResponse, CappuccinoAPIHeader, CappuccinoAPIBlock, CappuccinoAPITransactionResponse> {
