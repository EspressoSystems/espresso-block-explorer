 ...
 */
export interface HotShotQueryServiceAvailabilityAPI extends IHotShotQueryServiceAvailabilityAPI<AvailabilityAPILeafResponse, AvailabilityAPIHeader, AvailabilityAPIBlock, AvailabilityAPITransactionResponse> {
