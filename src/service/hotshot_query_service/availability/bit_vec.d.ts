 ...
 */
export declare class BitVec implements Iterable<boolean> {
    readonly order: BitVecOrder;
    readonly head: BitVecHead;
    readonly bits: number;
    readonly data: bigint[];
    constructor(order: BitVecOrder, head: BitVecHead, bits: number, data: bigint[]);
...
export declare class BitVecDecoder implements Converter<unknown, BitVec> {
    convert(input: unknown): BitVec;
}
export declare class BitVecEncoder implements Converter<BitVec> {
...
export declare class BitVecCodec extends TypeCheckingCodec<BitVec, ReturnType<InstanceType<new () => BitVecEncoder>['convert']>> {
    readonly encoder: BitVecEncoder;
    readonly decoder: BitVecDecoder;
}
export declare const bitVecCodec: BitVecCodec;
export declare const bitVecArrayCodec: ArrayCodec<BitVec, {
    order: string;
    head: {
        width: number;
        index: number;
