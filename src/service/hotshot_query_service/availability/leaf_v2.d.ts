...
export declare class LeafV2 {
    ...
    constructor(view_number: number, justify_qc: QuorumCertificateV2, next_epoch_justify_qc: null | QuorumCertificateV2, parent_commitment: TaggedBase64, block_header: AvailabilityAPIHeader, upgrade_certificate: null | UpgradeCertificateV1, block_payload: null | AvailabilityAPIPayload, view_change_evidence: null | ViewChangeEvidenceV2, next_drb_result: null | Uint8Array, with_epoch: boolean);
    toJSON(): {
        view_number: number;
