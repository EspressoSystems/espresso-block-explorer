...
import { BitVec } from '../../../../../../../../../../../../src/service/hotshot_query_service/availability/bit_vec';
...
export declare class ActiveNodeSetDiffNewBlock extends ActiveNodeSetDiff {
    ...
    readonly votersBitVec: BitVec;
    constructor(leaderIndex: number, failedLeaders: number[], votersBitVec: BitVec);
    toJSON(): unknown;
}
/**
