...
export declare class NodeValidatorServiceResponse extends WebWorkerProxyResponse {
    readonly response: NodeValidatorResponse;
    get type(): string;
...
declare class NodeValidatorResponseToWebWorkerProxyResponseConverter implements Converter<NodeValidatorResponse, WebWorkerProxyResponse> {
