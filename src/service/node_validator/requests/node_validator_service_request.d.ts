...
export declare class NodeValidatorServiceRequest extends WebWorkerProxyRequest {
    readonly request: NodeValidatorRequest;
...
declare class NodeValidatorRequestToWebWorkerProxyRequestConverter implements Converter<NodeValidatorRequest, NodeValidatorServiceRequest> {
    convert(input: NodeValidatorRequest): NodeValidatorServiceRequest;
}
