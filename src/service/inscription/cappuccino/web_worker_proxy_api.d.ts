 ...
 */
export interface WebWorkerInscriptionAPI extends InscriptionAPI<WebWorkerProxyRequest, WebWorkerProxyResponse> {
}
/**
 * kInscriptionMessageToSign is a constant string that represents the message
 * that should be signed by the Inscription API.
 */
export declare const kInscriptionMessageToSign = "An Infinite Garden has no walls";
/**
 ...
 */
export declare class UnimplementedWebWorkerInscriptionAPI implements WebWorkerInscriptionAPI {
