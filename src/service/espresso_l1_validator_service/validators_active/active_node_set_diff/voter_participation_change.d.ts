 ...
 */
export declare class VoterParticipationChange extends ActiveNodeSetDiff {
 ...
 */
declare class VoterParticipationChangeJSONDecoder implements Converter<unknown, VoterParticipationChange> {
 ...
 */
declare class VoterParticipationChangeJSONEncoder implements Converter<VoterParticipationChange, unknown> {
