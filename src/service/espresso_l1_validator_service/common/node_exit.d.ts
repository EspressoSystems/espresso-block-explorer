 ...
 * object.
 */
declare class ValidatorExitEntryJSONDecoder implements Converter<unknown, NodeExit> {
 ...
 * object.
 */
declare class ValidatorExitEntryJSONEncoder implements Converter<NodeExit, unknown> {
 ...
 */
declare class ValidatorExitEntryJSONCodec extends TypeCheckingCodec<NodeExit, unknown> {
