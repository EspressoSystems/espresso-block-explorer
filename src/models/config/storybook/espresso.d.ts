 ...
 */
export declare function deriveAddressesWithEnvironmentFallback(espTokenContractAddress?: null | `0x${string}`, stakeTableContractAddress?: null | `0x${string}`, rewardClaimContractAddress?: null | `0x${string}`, lightClientContractAddress?: null | `0x${string}`): {
