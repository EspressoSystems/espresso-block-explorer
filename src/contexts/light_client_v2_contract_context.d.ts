 ...
 */
export declare const LightClientV2ContractGasEstimatorContext: React.Context<import('../contracts').GasEstimatorForContract<import('../contracts/light_client_v2/light_client_v2_interface').LightClientV2ContractWriteable> | null>;
/**
