 ...
 */
export declare const StakeTableContractGasEstimatorContext: React.Context<import('../contracts').GasEstimatorForContract<import('../contracts/stake_table/stake_table_interface').StakeTableContractWriteable> | null>;
/**
