...
import { StakeTableV2Contract, UndelegationInfo } from './stake_table_v2_interface';
export declare class StakeTableV2Remote extends StakeTableRemote implements StakeTableV2Contract {
    ...
    getUndelegation(validator: `0x${string}`, delegator: `0x${string}`): Promise<UndelegationInfo>;
    minDelegateAmount(): Promise<bigint>;
    validateMetadataUri(uri: string): Promise<void>;
    private writeContractV2;
    ...
    registerValidatorV2(blsVk: {
        ...
        x: bigint;
        y: bigint;
    }, schnorrSig: `0x${string}`, commission: number, metadataUri: string): Promise<`0x${string}`>;
}
