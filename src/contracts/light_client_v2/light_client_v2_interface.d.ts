...
import { LightClientContractReadOnly, LightClientContractWriteable, StakeTableState } from '../light_client/light_client_interface';
...
export interface LightClientV2Contract extends LightClientV2ContractReadOnly, LightClientV2ContractWriteable {
}
export type LightClientV2ContractGasEstimator = GasEstimatorForContract<LightClientV2ContractWriteable>;
