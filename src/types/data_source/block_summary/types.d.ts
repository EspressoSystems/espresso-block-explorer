...
export type BlockSummary = Pick<BlockDetail, 'height' | 'proposer' | 'size' | 'time' | 'transactions'>;
...
export interface BlockSummaryAsyncRetriever extends AsyncRetriever<BlockSummaryRequest, BlockSummary[]> {
}
