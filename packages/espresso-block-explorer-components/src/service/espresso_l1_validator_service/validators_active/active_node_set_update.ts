...
import { activeNodeSetDiffArrayJSONCodec } from './active_node_set_diff/active_node_set_diff_codec';
...
export class ActiveNodeSetUpdate {
  ...
  toJSON() {
    return activeNodeSetUpdateJSONCodec.encode(this);
  }
}
  ...
  implements Converter<unknown, ActiveNodeSetUpdate>
{
  convert(input: unknown): ActiveNodeSetUpdate {
    ...
    return new ActiveNodeSetUpdate(
      ...
      activeNodeSetDiffArrayJSONCodec.decode(input.diff),
    );
  }
}
  ...
  implements Converter<ActiveNodeSetUpdate, unknown>
{
  convert(input: ActiveNodeSetUpdate): unknown {
    return {
      ...
      diff: activeNodeSetDiffArrayJSONCodec.encode(input.diff),
    };
  }
}
 ...
 */
class ActiveNodeSetUpdateJSONCodec extends TypeCheckingCodec<
  ActiveNodeSetUpdate,
  unknown
> {
  readonly encoder = new ActiveNodeSetUpdateJSONEncoder();
  readonly decoder = new ActiveNodeSetUpdateJSONDecoder();
}
 ...
 * ActiveNodeSetUpdate objects to and from JSON.
 */
export const activeNodeSetUpdateJSONCodec = new ActiveNodeSetUpdateJSONCodec();
