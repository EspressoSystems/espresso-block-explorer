...
import { nodeIdentitySnapshotCodec } from '../node_identity_snapshot';
...
describe('NodeIdentitySnapshot', () => {
  it('should decode from json', () => {
    const rawString =
      '{"NodeIdentitySnapshot":[{"public_key":"BLS_VER_KEY~r6b-Cwzp-b3czlt0MHmYPJIow5kMsXbrNmZsLSYg9RV49oCCO4WEeCRFR02x9bqLCa_sgNFMrIeNdEa11qNiBAohApYFIvrSa-zP5QGj3xbZaMOCrshxYit6E2TR-XsWvv6gjOrypmugjyTAth-iqQzTboSfmO9DD1-gjJIdCaD7","name":null,"wallet_address":null,"public_url":null,"company":null,"company_website":null,"location":null,"operating_system":null,"node_type":null,"network_type":null},{"public_key":"BLS_VER_KEY~IBRoz_Q1EXvcm1pNZcmVlyYZU8hZ7qmy337ePAjEMhz8Hl2q8vWPFOd3BaLwgRS1UzAPW3z4E-XIgRDGcRBTAMZX9b_0lKYjlyTlNF2EZfNnKmvv-xJ0yurkfjiveeYEsD2l5d8q_rJJbH1iZdXy-yPEbwI0SIvQfwdlcaKw9po4","name":null,"wallet_address":null,"public_url":null,"company":null,"company_website":null,"location":null,"operating_system":null,"node_type":null,"network_type":null},{"public_key":"BLS_VER_KEY~rO2PIjyY30HGfapFcloFe3mNDKMIFi6JlOLkH5ZWBSYoRm5fE2-Rm6Lp3EvmAcB5r7KFJ0c1Uor308x78r04EY_sfjcsDCWt7RSJdL4cJoD_4fSTCv_bisO8k98hs_8BtqQt8BHlPeJohpUXvcfnK8suXJETiJ6Er97pfxRbzgAL","name":"sequencer3","wallet_address":"0x0000000000000000000000000000000000000003","public_url":null,"company":"Espresso Systems","company_website":null,"location":{ "coords":[35.8617, 104.1954], "country":"CN" },"operating_system":"Microsoft Windows NT 10.0.22621.0","node_type":"espresso-sequencer 0.1","network_type":"local"},{"public_key":"BLS_VER_KEY~bQszS-QKYvUij2g20VqS8asttGSb95NrTu2PUj0uMh1CBUxNy1FqyPDjZqB29M7ZbjWqj79QkEOWkpga84AmDYUeTuWmy-0P1AdKHD3ehc-dKvei78BDj5USwXPJiDUlCxvYs_9rWYhagaq-5_LXENr78xel17spftNd5MA1Mw5U","name":"sequencer0","wallet_address":"0x0000000000000000000000000000000000000000","public_url":null,"company":"Espresso Systems","company_website":null,"location":{ "coords":[40.7128, -74.006], "country":"US" },"operating_system":"Linux 5.15.153.1","node_type":"espresso-sequencer 0.1","network_type":"local"},{"public_key":"BLS_VER_KEY~4zQnaCOFJ7m95OjxeNls0QOOwWbz4rfxaL3NwmN2zSdnf8t5Nw_dfmMHq05ee8jCegw6Bn5T8inmrnGGAsQJMMWLv77nd7FJziz2ViAbXg-XGGF7o4HyzELCmypDOIYF3X2UWferFE_n72ZX0iQkUhOvYZZ7cfXToXxRTtb_mwRR","name":"sequencer1","wallet_address":"0x0000000000000000000000000000000000000001","public_url":null,"company":"Espresso Systems","company_website":null,"location":{ "coords":[39.0742, 21.8243], "country":"GR" },"operating_system":"Darwin 23.5.0","node_type":"espresso-sequencer 0.1","network_type":"local"},{"public_key":"BLS_VER_KEY~IBRoz_Q1EXvcm1pNZcmVlyYZU8hZ7qmy337ePAjEMhz8Hl2q8vWPFOd3BaLwgRS1UzAPW3z4E-XIgRDGcRBTAIGlhxgi93kY9qWMMzTmG6T1LRaSujLc7T67sqjD1H0rl7_X8jZhIolDXvQFLJWOmzmUEX-C_cTnqZjMb9CdbRUt","name":null,"wallet_address":null,"public_url":null,"company":null,"company_website":null,"location":null,"operating_system":null,"node_type":null,"network_type":null},{"public_key":"BLS_VER_KEY~r6b-Cwzp-b3czlt0MHmYPJIow5kMsXbrNmZsLSYg9RV49oCCO4WEeCRFR02x9bqLCa_sgNFMrIeNdEa11qNiBD3cekIRaiZpId6hgo_HoYCE773-B33eVf4lHn2hVOgZif7bSyyZedDsOk2o2krf7VCFEv0WrWB0GkGRVOAwWxCV","name":null,"wallet_address":null,"public_url":null,"company":null,"company_website":null,"location":null,"operating_system":null,"node_type":null,"network_type":null}]}';

    const response = nodeIdentitySnapshotCodec.decode(JSON.parse(rawString));
...

    {
      ...
      expect(node0.companyWebsite).toBe(null);
    ...
    expect(response.toJSON()).toStrictEqual(
      nodeIdentitySnapshotCodec.encode(response),
    );

    expect(
      nodeValidatorResponseCodec.decode(JSON.parse(rawString)),
    ).toStrictEqual(nodeIdentitySnapshotCodec.decode(JSON.parse(rawString)));
