...
import * as stories from '../__docs__/TransactionsPage.stories';

const { Transactions } = composeStories(stories);

describe('TransactionsPage', async () => {
  it('should render the story', async () => {
    render(<Transactions data-testid="1" />);
