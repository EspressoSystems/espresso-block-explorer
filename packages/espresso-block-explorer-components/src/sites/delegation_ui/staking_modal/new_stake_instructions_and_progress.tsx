...
export const NewStakeInstructionsAndProgress: React.FC = () => {
  ...
  if (stakingAmount.value > allowance) {
    ...
    if (
      ...
      approveData === null ||
      !(approveData instanceof PerformApproveReceiptReceived)
    ) {
      return (
    ...
    if (approveData instanceof PerformApproveReceiptReceived) {
      return (
  ...
  if (
    ...
    data === null ||
    !(data instanceof PerformDelegationReceiptRetrieved)
  ) {
    return (
