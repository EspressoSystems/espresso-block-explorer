...
const meta: Meta = {
  title: 'Delegation UI/Staking Modal/States/Withdraw Exit',
  ...DefaultMeta,
  args: {
    ...DefaultMeta.args,
    selection: new ValidatorConfirmedExitWithdraw(
      hexArrayBufferCodec.encode(nodeList[INDEX_EXIT].address),
    ),
