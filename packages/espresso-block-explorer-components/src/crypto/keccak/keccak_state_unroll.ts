...
// p100 is a loop unroll of computing the keccak p1600 permutation
// as described in the Keccak specification.
// This code was taken from the 'keccak' package, and modified to work
// with Uint8Array instead of Buffer
export function p1600(s: number[]) {
