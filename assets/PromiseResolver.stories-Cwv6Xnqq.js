import{j as r,R as h}from"./iframe-DygLW6I0.js";import{N as v}from"./NotFoundError-D156Q_Lb.js";import{C as w}from"./CircularProgressIndicator-cfigQE3z.js";import{T as m}from"./Text-BU7JBOLk.js";import{A as C,a as D}from"./ProvideAsyncStates-B4f0kEob.js";import{P as E}from"./PromiseResolver-ZjmnF0wX.js";import"./string-BI8AIx1I.js";import"./higher_order-BcLzZ7W3.js";import"./LoadingProvider-Byfo0QzP.js";import"./MissingElementError-BiJAxgGE.js";import"./UnimplementedError-N0odIfDD.js";async function y(e){return new Promise(a=>{const R=setTimeout(()=>{clearTimeout(R),a()},e)})}const A=()=>{const e=h.useContext(C);if(e.asyncState===D.waiting)return r.jsx(w,{});if(e.error)return r.jsx(m,{text:"Error: "+e.error.toString()});const a=e.data;return r.jsx(m,{text:String(a)})},T=e=>r.jsx(E,{promise:e.promise,children:r.jsx(A,{})}),G={title:"Components/Async/Promise Resolver",component:T},o={args:{promise:y(2e3).then(()=>"Done!")}},s={args:{promise:new Promise(()=>{})}},t={args:{promise:Promise.resolve("Done!")}},n={args:{promise:Promise.reject(new v("nothing"))}};var i,c,p;o.parameters={...o.parameters,docs:{...(i=o.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
