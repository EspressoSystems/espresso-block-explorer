import{j as e,R as p}from"./iframe-uLWYWIdy.js";import{C as c}from"./circular_progress_indicator-BhHLUWnl.js";import{N as u}from"./not_found_error-D_XgWhca.js";import{n as d}from"./loading_provider-BM5-2tPO.js";import{T as m}from"./text-CEhLEmI-.js";import{A as g,a as l}from"./provide_async_states-DlviSoxq.js";import{P as x}from"./promise_resolver-BocC3IZa.js";import"./preload-helper-PPVm8Dsz.js";import"./higher_order-BV5WAo3w.js";import"./string-BsSBvYb_.js";import"./assert-B11BgmXM.js";import"./sleep-CW-vxfof.js";import"./missing_element_error-BOXFIEXu.js";import"./unimplemented_error-B7nptaaw.js";import"./data_provider-wCUWR71U.js";async function f(r){return new Promise(a=>{const i=setTimeout(()=>{clearTimeout(i),a()},r)})}const P=()=>{const r=p.useContext(g);if(r.asyncState===l.waiting)return e.jsx(c,{});if(r.error)return e.jsx(m,{text:"Error: "+r.error.toString()});const a=r.data;return e.jsx(m,{text:String(a)})},j=r=>e.jsx(x,{promise:r.promise,children:e.jsx(P,{})}),I={title:"Components/Async/Promise Resolver",component:j},o={args:{promise:f(2e3).then(()=>"Done!")}},s={args:{promise:d}},t={args:{promise:Promise.resolve("Done!")}},n={args:{promise:Promise.reject(new u("nothing"))}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
