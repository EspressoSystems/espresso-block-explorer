import{j as t,R as e}from"./iframe-BmS3xRbu.js";import{S as Q}from"./skeleton_content-1t1_tVBp.js";import{u as O,b as Z,g as tt,a as et,c as st,d as ot,e as at,f as nt}from"./svg_tool_tip-D5fxg0uT.js";import{A as H}from"./affine_transform-UCCpzMIM.js";import{N as C}from"./number_text-3CvBpJ-A.js";import"./byte_size_text-PjHd0T68.js";import"./transactions_per_second_text-BxWYGwIH.js";import"./date_time_text-BBJvh5H4.js";import"./full_hex_text-d5cXjKw4.js";import"./hex_text-Ck3buGva.js";import"./money_text-E5QuoP91.js";import"./relative_time_since_date_text-yVEMwZZM.js";import"./tagged_base64_text-BV90GCUN.js";import{T as y}from"./text-CEhLEmI-.js";import"./time_text-Dw6glsXQ.js";import{a as it}from"./higher_order-BcBNDTSF.js";import{a as rt}from"./typography-Cewt00oL.js";class h{min;max;mean;total;count;length;get nullableMean(){return this.count===0?null:this.mean}constructor(o,a,n,i,r){this.min=o,this.max=a,this.total=n,this.count=i,this.length=r,this.mean=n/i}static compute(o){return ct(o)}static empty=new h(0,0,0,0,0)}function ct(s){const o=s.length;if(o===0)return new h(0,0,0,0,0);let a=null,n=null,i=0,r=0;for(let d=0;d<o;d++){const m=s[d];m!==null&&(r++,i+=m,(a===null||m<a)&&(a=m),(n===null||m>n)&&(n=m))}const l=a===n;return l&&a!==0&&(a=0),l&&n===0&&(n=1),new h(a??0,n??0,i??0,r,o)}const b=s=>t.jsx(C,{number:s.value});try{b.displayName="HistogramDefaultLabel",b.__docgenInfo={description:`HistogramDefaultLabel is a simple label for displaying a numeric value for
