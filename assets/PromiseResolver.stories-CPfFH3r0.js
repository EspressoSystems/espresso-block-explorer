import{j as e}from"./jsx-runtime-BlAj40OV.js";import{N as h}from"./NotFoundError-CI-iUI-y.js";import{C as v}from"./CircularProgressIndicator-CmmjYXfy.js";import{T as m}from"./Text-BU7JBOLk.js";import{R as w}from"./index-Cs7sjTYM.js";import{A as C,a as D}from"./ProvideAsyncStates-DyGIG4hw.js";import{P as E}from"./PromiseResolver-CXCa4yLm.js";import"./string-BRHtp8nH.js";import"./higher_order-DnPEgWEz.js";import"./_commonjsHelpers-BosuxZz1.js";import"./LoadingProvider-Cf52ybPZ.js";async function y(r){return new Promise(a=>{const R=setTimeout(()=>{clearTimeout(R),a()},r)})}const A=()=>{const r=w.useContext(C);if(r.asyncState===D.waiting)return e.jsx(v,{});if(r.error)return e.jsx(m,{text:"Error: "+r.error.toString()});const a=r.data;return e.jsx(m,{text:String(a)})},T=r=>e.jsx(E,{promise:r.promise,children:e.jsx(A,{})}),G={title:"Components/Async/Promise Resolver",component:T},o={args:{promise:y(2e3).then(()=>"Done!")}},s={args:{promise:new Promise(()=>{})}},t={args:{promise:Promise.resolve("Done!")}},n={args:{promise:Promise.reject(new h("nothing"))}};var i,c,p;o.parameters={...o.parameters,docs:{...(i=o.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
