...
a single element of sufficient size.`,displayName:"ValueLabeled",props:{className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}}}}}catch{}const T=class T{constructor(a,o,n,i,r){p(this,"min");p(this,"max");p(this,"mean");p(this,"total");p(this,"count");p(this,"length");this.min=a,this.max=o,this.total=n,this.count=i,this.length=r,this.mean=n/i}static compute(a){return Ae(a)}};p(T,"empty",new T(0,0,0,0,0));let g=T;function Ae(t){const a=t.length;if(a===0)return new g(0,0,0,0,0);let o=null,n=null,i=0,r=0;for(let d=0;d<a;d++){const h=t[d];h!==null&&(r++,i+=h,(o===null||h<o)&&(o=h),(n===null||h>n)&&(n=h))}const c=o===n;return c&&o!==0&&(o=0),c&&n===0&&(n=1),new g(o??0,n??0,i??0,r,a)}const C=t=>e.jsx(A,{number:t.value});C.propTypes={value:be.number.isRequired};try{C.displayName="HistogramDefaultLabel",C.__docgenInfo={description:`HistogramDefaultLabel is a simple label for displaying a numeric value for
...
- HistogramYAxisGuideLines
- HistogramRangeAffineTransform
- HistogramYAxisLabelComponent`,displayName:"HistogramYAxisLabels",props:{labelsRef:{defaultValue:null,description:"",name:"labelsRef",required:!0,type:{name:"RefObject<SVGGElement> | undefined"}}}}}catch{}const K=ne("text"),Q=k("text"),Z=10,We=2,H=14,ee=14,I=()=>{const t=s.useContext(P).length,a=s.useContext(q),o=s.useContext(M),n=s.useContext(x),i=o/t,r=a.width/2;return e.jsx(ue.Provider,{value:ze,children:e.jsx(fe.Provider,{value:De,children:e.jsx(ve.Provider,{value:n,children:e.jsx(_e.Provider,{value:a.x+r,children:e.jsx(ye.Provider,{value:a.y,children:e.jsx(He.Provider,{value:i,children:e.jsx(je,{})})})})})})})},De=()=>{const t=s.useContext(q),a=t.width/2;return e.jsxs(e.Fragment,{children:[e.jsx("circle",{className:"value-pointer--outer",cx:t.x+a,cy:t.y,r:Z}),e.jsx("circle",{className:"value-pointer--inner",cx:t.x+a,cy:t.y,r:Z-We})]})},ze=()=>{const t=s.useContext($),a=s.useContext(U),o=s.useContext(M),n=s.useContext(ce);return n===null?e.jsxs(e.Fragment,{children:[e.jsx(K,{className:"tooltip--value-label",x:0,y:H,textAnchor:"start",children:e.jsx(m,{text:"Missing Data"})}),e.jsxs(Q,{className:"tooltip--value-label",x:0,y:H+ee,textAnchor:"start",children:[e.jsx(m,{text:"Block "}),e.jsx(A,{number:Number(t[0])+o})]})]}):e.jsxs(e.Fragment,{children:[e.jsx(K,{className:"tooltip--value-label",x:0,y:H,textAnchor:"start",children:s.createElement(a,{value:n})}),e.jsxs(Q,{className:"tooltip--value-label",x:0,y:H+ee,textAnchor:"start",children:[e.jsx(m,{text:"Block "}),e.jsx(A,{number:Number(t[o])})]})]})};try{I.displayName="HistogramTooltip",I.__docgenInfo={description:"",displayName:"HistogramTooltip",props:{}}}catch{}const S=16,V=()=>{const t=s.useContext(Y),a=s.useContext(u),o=s.useContext(x),n=s.useContext(P),i=s.useContext(v),r=s.useContext(_);if(i.length===0)return e.jsx(e.Fragment,{});const c=(a-S-S)/i.length,d=Math.floor(c),h=d*i.length,y=n.map(f=>r.transform(Number(f))),O=t-h-S;return e.jsxs(e.Fragment,{children:[e.jsx("g",{className:"histogram-plot",transform:`translate(${O},0)`,role:"graphics-datagroup",children:n.map((f,l)=>f===null?e.jsx("rect",{role:"graphics-dataunit",className:"missing",x:l*d,y:0,width:d-1,height:o,"data-offset":l},`missing-${l}`):e.jsx("rect",{role:"graphics-dataunit",className:"bar",x:l*d,y:o-y[l],width:d-1,height:y[l],"data-offset":l},`bar-${l}`))}),e.jsx("g",{className:"histogram-plot",transform:`translate(${O},0)`,children:n.map((f,l)=>e.jsxs("g",{children:[e.jsx("rect",{className:"bbox",x:l*d,y:0,height:o,width:d}),e.jsx(ce.Provider,{value:f,children:e.jsx(M.Provider,{value:l,children:e.jsx(q.Provider,{value:{x:l*d,y:o-y[l],width:d,height:y[l]},children:e.jsx(I,{})})})})]},`tooltip-${l}`))})]})};try{V.displayName="HistogramPlot",V.__docgenInfo={description:`HistogramPlot is a component that takes the given data and creates
