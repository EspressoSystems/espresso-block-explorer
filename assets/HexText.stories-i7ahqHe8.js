import{a as p,j as m}from"./jsx-runtime-evMRDBC5.js";import{m as s,a as c}from"./functional-h1qx9GTM.js";import"./index-4g5l5LRQ.js";import"./_commonjsHelpers-4gQjN7DL.js";const n=r=>{const e=Array.from(s(s(c(new Uint8Array(r.value),Number),a=>a.toString(16)),a=>a.padStart(2,"0"))).join("");return e.length<=12?`0x${e}`:p("span",{title:`0x${e}`,children:["0x",e.substring(0,6),"...",e.substring(e.length-6)]})};try{n.displayName="HexText",n.__docgenInfo={description:`HexText is a simple Text component that renders the given ArrayBuffer as
