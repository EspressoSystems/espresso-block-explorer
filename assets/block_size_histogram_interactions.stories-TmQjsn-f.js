import{j as c}from"./iframe-DygLW6I0.js";import{D as g}from"./LoadingProvider-Byfo0QzP.js";import"./DateTimeFormattersProvider-BiVnDCug.js";import"./LocaleProvider-BTog8Eg4.js";import"./NavDrawerStateProvider-Dcgn9ff6.js";import"./NowProvider-DQJHzESf.js";import"./NumberFormattersProvider-KKfvmIDJ.js";import"./PathResolverProvider-DvoeaLUs.js";import{f as v,d as m,b as u,i as p}from"./functional-C2YPzjZP.js";import{B as x}from"./BlockSizeHistogram-B1QWgZSV.js";import"./MissingElementError-BiJAxgGE.js";import"./string-BI8AIx1I.js";import"./UnimplementedError-N0odIfDD.js";import"./Card-1sZgTX0b.js";import"./higher_order-BcLzZ7W3.js";import"./CopyButton-8dueJzwM.js";import"./CheckCircle-BdLDxcf0.js";import"./SVGIconBase-CwzDODLl.js";import"./Copy-Dqyni2LM.js";import"./typography-CE54FjU0.js";import"./label-BvScgLcI.js";import"./Text-BU7JBOLk.js";import"./CircularProgressIndicator-cfigQE3z.js";import"./ContainerLoading-Db1SnN1N.js";import"./SVGToolTip-DqrjToKh.js";import"./SVGPathBuilder-XZx_HA2Y.js";import"./AffineTransform-DiV9SxhF.js";import"./NumberText-Xd59w2dg.js";import"./ByteSizeText-DuXrE04_.js";import"./base64-r9vyOGQT.js";/* empty css               */import"./CopyHex-CEMjEX2K.js";import"./array_buffer-CitSjtn6.js";import"./DateTimeText-DIi2HOf5.js";import"./FullHexText-Cvhkr5BV.js";import"./HexText-CTOvGOwi.js";import"./MoneyText-bbRHOGLR.js";import"./RelativeTimeText-Dw-jd3cC.js";import"./TaggedBase64Text-DsBCJTAo.js";import"./TimeText-D5fkU9y0.js";import"./Heading2-DOpmjall.js";/* empty css                */const{expect:i,userEvent:O,waitFor:h,within:I}=__STORYBOOK_MODULE_TEST__,w=async t=>{const a=await I(t).findByRole("graphics-datachart");return await i(a).toBeTruthy(),await i(a).toBeInTheDocument(),a};function B(t){t.querySelectorAll('[data-hover="true"]').forEach(a=>{a.removeAttribute("data-hover")})}async function E(t,a){return B(t),a.setAttribute("data-hover","true"),O.hover(a)}const S=t=>{const o=t.querySelectorAll(".bbox")[Symbol.iterator]();return u(o,e=>e)},T=t=>{const o=t.querySelectorAll(".tooltip")[Symbol.iterator]();return u(o,e=>e)},r=async(t,a)=>{const o=await w(t);await h(async()=>{const H=await w(t);i(H).toBeInTheDocument()},{timeout:1e3});const e=S(o),d=T(o),f=v(m(e,a)),s=v(m(d,a));await E(t,f),await h(async()=>{i(s).toBeVisible()}),i(s).toBeVisible()},A=async t=>B(t),_=({data:t,...a})=>c.jsx(g.Provider,{value:t,children:c.jsx(x,{...a})}),dt={title:"Components/Page Sections/Histogram/Block Size/Interactions",component:_},n={args:{data:{blocks:[...p(10)],blockSize:[...p(10)]}},play:async({canvasElement:t,step:a})=>{await a("Hover over first bar",async()=>{await r(t,0)}),await a("Hover over second bar",async()=>{await r(t,1)}),await a("Hover over third bar",async()=>{await r(t,2)}),await a("Hover over fourth bar",async()=>{await r(t,3)}),await a("Hover over fifth bar",async()=>{await r(t,4)}),await a("Hover over sixth bar",async()=>{await r(t,5)}),await a("Hover over seventh bar",async()=>{await r(t,6)}),await a("Hover over eighth bar",async()=>{await r(t,7)}),await a("Hover over ninth bar",async()=>{await r(t,8)}),await a("Hover over tenth bar",async()=>{await r(t,9)}),await a("Mouse off",async()=>{await A(t)})}};var l,b,y;n.parameters={...n.parameters,docs:{...(l=n.parameters)==null?void 0:l.docs,source:{originalSource:`{
  args: {
    data: {
      blocks: [...iota(10)],
      blockSize: [...iota(10)]
