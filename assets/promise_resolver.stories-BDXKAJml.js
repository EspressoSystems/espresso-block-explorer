import{j as e,R as c}from"./iframe-CUSUi-ol.js";import{N as p}from"./not_found_error-MIy2_s-e.js";import{n as u}from"./loading_provider-DxXUP5j3.js";import{C as d}from"./circular_progress_indicator-DukX7415.js";import{T as m}from"./text-CEhLEmI-.js";import{A as g,a as l}from"./provide_async_states-CyiC9owZ.js";import{P as x}from"./promise_resolver-Bw0_96Le.js";import"./preload-helper-PPVm8Dsz.js";import"./string-BQNQEiqR.js";import"./assert-B11BgmXM.js";import"./missing_element_error-BkHusKs0.js";import"./unimplemented_error-C5MN7yCC.js";import"./higher_order-CE7HgP1S.js";async function f(r){return new Promise(a=>{const i=setTimeout(()=>{clearTimeout(i),a()},r)})}const P=()=>{const r=c.useContext(g);if(r.asyncState===l.waiting)return e.jsx(d,{});if(r.error)return e.jsx(m,{text:"Error: "+r.error.toString()});const a=r.data;return e.jsx(m,{text:String(a)})},j=r=>e.jsx(x,{promise:r.promise,children:e.jsx(P,{})}),L={title:"Components/Async/Promise Resolver",component:j},o={args:{promise:f(2e3).then(()=>"Done!")}},s={args:{promise:u}},t={args:{promise:Promise.resolve("Done!")}},n={args:{promise:Promise.reject(new p("nothing"))}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
