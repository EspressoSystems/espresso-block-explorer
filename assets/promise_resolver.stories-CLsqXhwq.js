import{j as e,R as p}from"./iframe-Da-pRdj_.js";import{C as c}from"./circular_progress_indicator-CmgbbPhU.js";import{N as u}from"./not_found_error-BdUVpmTw.js";import{n as d}from"./loading_provider-CkZUfCHZ.js";import{T as m}from"./text-CEhLEmI-.js";import{A as g,a as l}from"./provide_async_states-YzODn9jr.js";import{P as x}from"./promise_resolver-BUp_5laA.js";import"./preload-helper-PPVm8Dsz.js";import"./higher_order-BliYGj6D.js";import"./string-DwcMXV6G.js";import"./assert-B11BgmXM.js";import"./sleep-CW-vxfof.js";import"./missing_element_error-BXDBouYu.js";import"./unimplemented_error-BNblu8WE.js";import"./data_provider-DT5b-p5f.js";async function f(r){return new Promise(a=>{const i=setTimeout(()=>{clearTimeout(i),a()},r)})}const P=()=>{const r=p.useContext(g);if(r.asyncState===l.waiting)return e.jsx(c,{});if(r.error)return e.jsx(m,{text:"Error: "+r.error.toString()});const a=r.data;return e.jsx(m,{text:String(a)})},j=r=>e.jsx(x,{promise:r.promise,children:e.jsx(P,{})}),I={title:"Components/Async/Promise Resolver",component:j},o={args:{promise:f(2e3).then(()=>"Done!")}},s={args:{promise:d}},t={args:{promise:Promise.resolve("Done!")}},n={args:{promise:Promise.reject(new u("nothing"))}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
