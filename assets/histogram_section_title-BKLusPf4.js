import{j as t,R as e}from"./iframe-BisBQj4b.js";import{S as Q}from"./skeleton_content-BxEnkJYy.js";import{u as O,b as Z,g as tt,a as et,c as st,d as ot,e as at,f as nt}from"./svg_tool_tip-mC0zgJg0.js";import{A as H}from"./affine_transform-UCCpzMIM.js";import{N as C}from"./number_text-DzPmU_Wm.js";import"./byte_size_text-D02xq_qj.js";import"./transactions_per_second_text-CPHc-mtj.js";import"./date_time_text-CWBRTMWe.js";import"./full_hex_text-d5cXjKw4.js";import"./hex_text-ioJdFCKB.js";import"./money_text-CSyR9ORC.js";import"./relative_time_since_date_text-BcKaKuH7.js";import"./tagged_base64_text-BsrZb43h.js";import{T as y}from"./text-CEhLEmI-.js";import"./time_text-CQFUX5ML.js";import{a as it}from"./higher_order-B_D7TFYJ.js";import{a as rt}from"./typography-CoQDMpTx.js";class h{min;max;mean;total;count;length;get nullableMean(){return this.count===0?null:this.mean}constructor(o,a,n,i,r){this.min=o,this.max=a,this.total=n,this.count=i,this.length=r,this.mean=n/i}static compute(o){return ct(o)}static empty=new h(0,0,0,0,0)}function ct(s){const o=s.length;if(o===0)return new h(0,0,0,0,0);let a=null,n=null,i=0,r=0;for(let d=0;d<o;d++){const m=s[d];m!==null&&(r++,i+=m,(a===null||m<a)&&(a=m),(n===null||m>n)&&(n=m))}const l=a===n;return l&&a!==0&&(a=0),l&&n===0&&(n=1),new h(a??0,n??0,i??0,r,o)}const b=s=>t.jsx(C,{number:s.value});try{b.displayName="HistogramDefaultLabel",b.__docgenInfo={description:`HistogramDefaultLabel is a simple label for displaying a numeric value for
