import{j as t,R as o}from"./iframe-B_3OiDsk.js";import{S as Q}from"./skeleton_content-Tm-ZGR8J.js";import{u as O,b as Z,g as tt,a as et,c as st,d as ot,e as nt,f as at}from"./svg_tool_tip-S0AcDMpD.js";import{A as _}from"./affine_transform-CW2gj0SF.js";import{N as j}from"./number_text-CfPJ3WYP.js";import"./byte_size_text-UC0Wy2aR.js";import"./wallet_address_text-BcDYCoX5.js";import"./date_time_text-DHS6FkeB.js";import"./full_hex_text-DIaruHQS.js";import"./hex_text-D1xIiaNE.js";import"./money_text-libprYpi.js";import"./money_text_full-Cq_7593R.js";import"./percentage_text-DF3JRbdn.js";import"./relative_time_since_date_text-bBhZOZRw.js";import"./tagged_base64_text-Bmi60DJN.js";import{T as H}from"./text-CEhLEmI-.js";import"./time_text-B1STacQD.js";import{a as it,b as rt}from"./higher_order-B9fwTSHO.js";class h{min;max;mean;total;count;length;get nullableMean(){return this.count===0?null:this.mean}constructor(e,n,a,i,r){this.min=e,this.max=n,this.total=a,this.count=i,this.length=r,this.mean=a/i}static compute(e){return ct(e)}static empty=new h(0,0,0,0,0)}function ct(s){const e=s.length;if(e===0)return new h(0,0,0,0,0);let n=null,a=null,i=0,r=0;for(let c=0;c<e;c++){const m=s[c];m!==null&&(r++,i+=m,(n===null||m<n)&&(n=m),(a===null||m>a)&&(a=m))}const d=n===a;return d&&n!==0&&(n=0),d&&a===0&&(a=1),new h(n??0,a??0,i??0,r,e)}const C=s=>t.jsx(j,{number:s.value});try{C.displayName="HistogramDefaultLabel",C.__docgenInfo={description:`HistogramDefaultLabel is a simple label for displaying a numeric value for
