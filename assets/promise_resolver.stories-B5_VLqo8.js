import{j as e,R as p}from"./iframe-DFUTgPQB.js";import{C as c}from"./circular_progress_indicator-Cj9ZZ6bB.js";import{N as u}from"./not_found_error-DDa8r4Zj.js";import{n as d}from"./loading_provider-Dbx5KbTU.js";import{T as m}from"./text-CEhLEmI-.js";import{A as g,a as l}from"./provide_async_states-HfLtbb39.js";import{P as x}from"./promise_resolver-XYcoMnTb.js";import"./preload-helper-PPVm8Dsz.js";import"./higher_order-DKNKSq1q.js";import"./string-DoEjSKSD.js";import"./assert-B11BgmXM.js";import"./sleep-CW-vxfof.js";import"./missing_element_error-BOfgw7mk.js";import"./unimplemented_error-CUVVCP1k.js";import"./data_provider-xp9wZ2A1.js";async function f(r){return new Promise(a=>{const i=setTimeout(()=>{clearTimeout(i),a()},r)})}const P=()=>{const r=p.useContext(g);if(r.asyncState===l.waiting)return e.jsx(c,{});if(r.error)return e.jsx(m,{text:"Error: "+r.error.toString()});const a=r.data;return e.jsx(m,{text:String(a)})},j=r=>e.jsx(x,{promise:r.promise,children:e.jsx(P,{})}),I={title:"Components/Async/Promise Resolver",component:j},o={args:{promise:f(2e3).then(()=>"Done!")}},s={args:{promise:d}},t={args:{promise:Promise.resolve("Done!")}},n={args:{promise:Promise.reject(new u("nothing"))}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
