import{j as t,R as e}from"./iframe-B98JvFlS.js";import{S as Q}from"./skeleton_content-CeIngfNJ.js";import{u as O,b as Z,g as tt,a as et,c as st,d as ot,e as at,f as nt}from"./svg_tool_tip-BRsee-7R.js";import{A as H}from"./affine_transform-UCCpzMIM.js";import{N as C}from"./number_text-DXEYwiPL.js";import"./byte_size_text-DtgDpAum.js";import"./transactions_per_second_text-DPJ1W9nL.js";import"./date_time_text-DxklR_a2.js";import"./full_hex_text-d5cXjKw4.js";import"./hex_text-D4MsPMwE.js";import"./money_text-lwZ5zskg.js";import"./relative_time_since_date_text-C2BerGEa.js";import"./tagged_base64_text-uunfgkXS.js";import{T as y}from"./text-CEhLEmI-.js";import"./time_text-CSpxpyZm.js";import{a as it}from"./higher_order-DFW_Utmg.js";import{a as rt}from"./typography-CVl34GaZ.js";class h{min;max;mean;total;count;length;get nullableMean(){return this.count===0?null:this.mean}constructor(o,a,n,i,r){this.min=o,this.max=a,this.total=n,this.count=i,this.length=r,this.mean=n/i}static compute(o){return ct(o)}static empty=new h(0,0,0,0,0)}function ct(s){const o=s.length;if(o===0)return new h(0,0,0,0,0);let a=null,n=null,i=0,r=0;for(let d=0;d<o;d++){const m=s[d];m!==null&&(r++,i+=m,(a===null||m<a)&&(a=m),(n===null||m>n)&&(n=m))}const l=a===n;return l&&a!==0&&(a=0),l&&n===0&&(n=1),new h(a??0,n??0,i??0,r,o)}const b=s=>t.jsx(C,{number:s.value});try{b.displayName="HistogramDefaultLabel",b.__docgenInfo={description:`HistogramDefaultLabel is a simple label for displaying a numeric value for
