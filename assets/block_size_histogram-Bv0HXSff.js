import{j as t,R as s}from"./iframe-DI-11s_X.js";import{a as K}from"./card-D3FygXcU.js";import{V as E}from"./value_labeled-9ZyU3RsZ.js";import{W as ot}from"./loading_shimmer-PSqwM2hU.js";import{S as Q}from"./skeleton_content-BJBzdtyc.js";import{D as at}from"./data_provider-DGnnlGIN.js";import{b as nt,L as it}from"./loading_provider-DZ2hJPrr.js";import{T as d}from"./text-CEhLEmI-.js";import{V as Z}from"./transactions_per_second_text-BfX5u5Mj.js";import{A as y}from"./affine_transform-UCCpzMIM.js";import{N}from"./number_text-BtfPTykZ.js";import{u as tt,b as rt,g as ct,a as lt,c as mt,d as dt,e as ht,f as gt}from"./svg_tool_tip-B-Mv_OtH.js";import"./byte_size_text-DEFkBL8V.js";import"./date_time_text-DPkozv3x.js";import"./full_hex_text-IJaD05bO.js";import"./hex_text-CNA63x8l.js";import"./money_text-DWVpZrzw.js";import"./relative_time_since_date_text-CL2VL2Wf.js";import"./tagged_base64_text-CvsXgAKe.js";import"./time_text-B0jFtZmy.js";import{a as xt}from"./higher_order-CE6OGbq-.js";import{a as pt}from"./typography-DVGLpPO5.js";class g{min;max;mean;total;count;length;get nullableMean(){return this.count===0?null:this.mean}constructor(o,a,n,i,r){this.min=o,this.max=a,this.total=n,this.count=i,this.length=r,this.mean=n/i}static compute(o){return ut(o)}static empty=new g(0,0,0,0,0)}function ut(e){const o=e.length;if(o===0)return new g(0,0,0,0,0);let a=null,n=null,i=0,r=0;for(let m=0;m<o;m++){const h=e[m];h!==null&&(r++,i+=h,(a===null||h<a)&&(a=h),(n===null||h>n)&&(n=h))}const l=a===n;return l&&a!==0&&(a=0),l&&n===0&&(n=1),new g(a??0,n??0,i??0,r,o)}const P=e=>t.jsx(N,{number:e.value});try{P.displayName="HistogramDefaultLabel",P.__docgenInfo={description:`HistogramDefaultLabel is a simple label for displaying a numeric value for
