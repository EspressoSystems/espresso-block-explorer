import{j as t,R as o}from"./iframe-D2UHUSw1.js";import{S as Q}from"./skeleton_content-PL2g6D7T.js";import{u as O,b as Z,g as tt,a as et,c as st,d as ot,e as nt,f as at}from"./svg_tool_tip-C2bRf1IP.js";import{A as _}from"./affine_transform-CW2gj0SF.js";import{N as j}from"./number_text-Dfa8DO6a.js";import"./byte_size_text-B8LVqjcy.js";import"./wallet_address_text-o_fKNCuy.js";import"./date_time_text-UFu38czj.js";import"./full_hex_text-DIaruHQS.js";import"./hex_text-qUJvM0mV.js";import"./money_text-D0xggOZ3.js";import"./money_text_full-c4Ixq9j3.js";import"./percentage_text-3gwyuOf8.js";import"./relative_time_since_date_text-BlTkaE0N.js";import"./tagged_base64_text-D99lZCjx.js";import{T as H}from"./text-CEhLEmI-.js";import"./time_text-C0-uqWbV.js";import{a as it,b as rt}from"./higher_order-Do31eXwD.js";class h{min;max;mean;total;count;length;get nullableMean(){return this.count===0?null:this.mean}constructor(e,n,a,i,r){this.min=e,this.max=n,this.total=a,this.count=i,this.length=r,this.mean=a/i}static compute(e){return ct(e)}static empty=new h(0,0,0,0,0)}function ct(s){const e=s.length;if(e===0)return new h(0,0,0,0,0);let n=null,a=null,i=0,r=0;for(let c=0;c<e;c++){const m=s[c];m!==null&&(r++,i+=m,(n===null||m<n)&&(n=m),(a===null||m>a)&&(a=m))}const d=n===a;return d&&n!==0&&(n=0),d&&a===0&&(a=1),new h(n??0,a??0,i??0,r,e)}const C=s=>t.jsx(j,{number:s.value});try{C.displayName="HistogramDefaultLabel",C.__docgenInfo={description:`HistogramDefaultLabel is a simple label for displaying a numeric value for
