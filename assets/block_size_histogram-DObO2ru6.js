import{j as t,R as s}from"./iframe-tCHaFxbc.js";import{a as K}from"./card-DvCX4YfC.js";import{V as E}from"./value_labeled-B7vNsMXu.js";import{W as ot}from"./loading_shimmer--34TiCD4.js";import{S as Q}from"./skeleton_content-B2LbE2wz.js";import{D as at}from"./data_provider-DMdJRqvD.js";import{b as nt,L as it}from"./loading_provider-CZPO-_kN.js";import{T as d}from"./text-CEhLEmI-.js";import{V as Z}from"./transactions_per_second_text-ovamH_lA.js";import{A as y}from"./affine_transform-UCCpzMIM.js";import{N}from"./number_text--8_8YX8A.js";import{u as tt,b as rt,g as ct,a as lt,c as mt,d as dt,e as ht,f as gt}from"./svg_tool_tip-C0xqwXIK.js";import"./byte_size_text-DQ9E5zJV.js";import"./date_time_text-CKrQdG-h.js";import"./full_hex_text-wUTAmwfT.js";import"./hex_text-xpN-YlgA.js";import"./money_text-PofDrM4B.js";import"./relative_time_since_date_text-MVqD1i7i.js";import"./tagged_base64_text-CAUH6KHu.js";import"./time_text-C3siLlpH.js";import{a as xt}from"./higher_order-DFvPhzqR.js";import{a as pt}from"./typography-ByNahrJv.js";class g{min;max;mean;total;count;length;get nullableMean(){return this.count===0?null:this.mean}constructor(o,a,n,i,r){this.min=o,this.max=a,this.total=n,this.count=i,this.length=r,this.mean=n/i}static compute(o){return ut(o)}static empty=new g(0,0,0,0,0)}function ut(e){const o=e.length;if(o===0)return new g(0,0,0,0,0);let a=null,n=null,i=0,r=0;for(let m=0;m<o;m++){const h=e[m];h!==null&&(r++,i+=h,(a===null||h<a)&&(a=h),(n===null||h>n)&&(n=h))}const l=a===n;return l&&a!==0&&(a=0),l&&n===0&&(n=1),new g(a??0,n??0,i??0,r,o)}const P=e=>t.jsx(N,{number:e.value});try{P.displayName="HistogramDefaultLabel",P.__docgenInfo={description:`HistogramDefaultLabel is a simple label for displaying a numeric value for
