import{j as t,R as e}from"./iframe-Czs2L5m1.js";import{S as Q}from"./skeleton_content-CzbtXqMN.js";import{u as O,b as Z,g as tt,a as et,c as st,d as ot,e as at,f as nt}from"./svg_tool_tip-BecNETuX.js";import{A as H}from"./affine_transform-UCCpzMIM.js";import{N as C}from"./number_text-NeBjfjp9.js";import"./byte_size_text-LFOa9cPx.js";import"./wallet_address_text-b1XU89BU.js";import"./date_time_text-DTv9voBS.js";import"./full_hex_text-B9F7kEcQ.js";import"./hex_text-D4ncCmSo.js";import"./money_text-BJ-uCKea.js";import"./money_text_full-Cn1Suzc2.js";import"./percentage_text-DYq2RApP.js";import"./relative_time_since_date_text-DLaNVU8u.js";import"./tagged_base64_text-BpgIJSgf.js";import{T as y}from"./text-CEhLEmI-.js";import"./time_text-DXVJqvoG.js";import{a as it,b as rt}from"./higher_order-Bg2qo-qh.js";class h{min;max;mean;total;count;length;get nullableMean(){return this.count===0?null:this.mean}constructor(o,a,n,i,r){this.min=o,this.max=a,this.total=n,this.count=i,this.length=r,this.mean=n/i}static compute(o){return ct(o)}static empty=new h(0,0,0,0,0)}function ct(s){const o=s.length;if(o===0)return new h(0,0,0,0,0);let a=null,n=null,i=0,r=0;for(let d=0;d<o;d++){const m=s[d];m!==null&&(r++,i+=m,(a===null||m<a)&&(a=m),(n===null||m>n)&&(n=m))}const l=a===n;return l&&a!==0&&(a=0),l&&n===0&&(n=1),new h(a??0,n??0,i??0,r,o)}const b=s=>t.jsx(C,{number:s.value});try{b.displayName="HistogramDefaultLabel",b.__docgenInfo={description:`HistogramDefaultLabel is a simple label for displaying a numeric value for
...
- HistogramYAxisGuideLines
- HistogramRangeAffineTransform
- HistogramYAxisLabelComponent`,displayName:"HistogramYAxisLabels",props:{labelsRef:{defaultValue:null,description:"",name:"labelsRef",required:!0,type:{name:"RefObject<SVGSVGElement | null> | undefined"}}}}}catch{}const $=10,pt=2,_=14,F=14,A=()=>{const s=e.useContext(I).length,o=e.useContext(V),a=e.useContext(W),n=e.useContext(g),i=a/s,r=o.width/2;return t.jsx(Z.Provider,{value:ut,children:t.jsx(tt.Provider,{value:xt,children:t.jsx(et.Provider,{value:n,children:t.jsx(st.Provider,{value:o.x+r,children:t.jsx(ot.Provider,{value:o.y,children:t.jsx(at.Provider,{value:i,children:t.jsx(nt,{})})})})})})})},xt=()=>{const s=e.useContext(V),o=s.width/2;return t.jsxs(t.Fragment,{children:[t.jsx("circle",{className:"value-pointer--outer",cx:s.x+o,cy:s.y,r:$}),t.jsx("circle",{className:"value-pointer--inner",cx:s.x+o,cy:s.y,r:$-pt})]})},ut=()=>{const s=e.useContext(X),o=e.useContext(K),a=e.useContext(W),n=e.useContext(J);return n===null?t.jsxs(t.Fragment,{children:[t.jsx("text",{className:"tooltip--value-label",x:0,y:_,textAnchor:"start",children:t.jsx(y,{text:"Missing Data"})}),t.jsxs("text",{className:"tooltip--value-label",x:0,y:_+F,textAnchor:"start",children:[t.jsx(y,{text:"Block "}),t.jsx(C,{number:Number(s[0])+a})]})]}):t.jsxs(t.Fragment,{children:[t.jsx("text",{className:"tooltip--value-label",x:0,y:_,textAnchor:"start",children:e.createElement(o,{value:n})}),t.jsxs("text",{className:"tooltip--value-label",x:0,y:_+F,textAnchor:"start",children:[t.jsx(y,{text:"Block "}),t.jsx(C,{number:Number(s[a])})]})]})};try{A.displayName="HistogramTooltip",A.__docgenInfo={description:"",displayName:"HistogramTooltip",props:{}}}catch{}const j=16,R=()=>{const s=e.useContext(G),o=e.useContext(p),a=e.useContext(g),n=e.useContext(I),i=e.useContext(v),r=e.useContext(u);if(i.length===0)return t.jsx(t.Fragment,{});const l=(o-j-j)/i.length,d=Math.floor(l),m=d*i.length,f=n.map(x=>r.transform(Number(x))),D=s-m-j;return t.jsxs(t.Fragment,{children:[t.jsx("g",{className:"histogram-plot",transform:`translate(${D},0)`,role:"graphics-datagroup",children:n.map((x,c)=>x===null?t.jsx("rect",{role:"graphics-dataunit",className:"missing",x:c*d,y:0,width:d-1,height:a,"data-offset":c},`missing-${c}`):t.jsx("rect",{role:"graphics-dataunit",className:"bar",x:c*d,y:a-f[c],width:d-1,height:f[c],"data-offset":c},`bar-${c}`))}),t.jsx("g",{className:"histogram-plot",transform:`translate(${D},0)`,children:n.map((x,c)=>t.jsxs("g",{children:[t.jsx("rect",{className:"bbox",x:c*d,y:0,height:a,width:d}),t.jsx(J.Provider,{value:x,children:t.jsx(W.Provider,{value:c,children:t.jsx(V.Provider,{value:{x:c*d,y:a-f[c],width:d,height:f[c]},children:t.jsx(A,{})})})})]},`tooltip-${c}`))})]})};try{R.displayName="HistogramPlot",R.__docgenInfo={description:`HistogramPlot is a component that takes the given data and creates
...
- HistogramRange
- HistogramRangeStatistics
- HistogramRangeAffineTransform`,displayName:"HistogramPlot",props:{}}}catch{}const w=({children:s})=>{const o=e.useContext(p),a=e.useContext(g),n=e.useContext(U),i=e.useContext(v),r=new H(n.min,n.max,0,o),l=new H(0,i.max,0,a);return t.jsx(dt.Provider,{value:r,children:t.jsx(u.Provider,{value:l,children:s})})},k=({children:s})=>{const o=e.useContext(X),a=e.useContext(I),n=h.compute(o),i=h.compute(a);return t.jsx(U.Provider,{value:n,children:t.jsx(v.Provider,{value:i,children:s})})},z=()=>{const[s,o]=O();return t.jsx(P,{children:t.jsx(B.Provider,{value:o,children:t.jsx(ft,{children:t.jsx(w,{children:t.jsxs(N,{children:[t.jsxs("g",{role:"graphics-axis",children:[t.jsx(T,{}),t.jsx(S,{labelsRef:s})]}),t.jsx(R,{})]})})})})})},ft=s=>{const o=e.useContext(p),a=e.useContext(B);return t.jsx(p.Provider,{value:Math.floor(o-(a?.width??0)),children:s.children})},E=()=>{const s=e.useContext(p),o=e.useContext(g),a=s/o;return t.jsx("div",{className:"histogram--placeholder",style:{paddingBottom:`${1/a*100}%`},children:t.jsx(Q,{})})};try{w.displayName="ProvideAffineTransforms",w.__docgenInfo={description:`ProvideAffineTransforms is a component that calculates the affineTransforms for
...
the histogram is loading.`,displayName:"SimpleHistogramPlaceholder",props:{}}}catch{}const _t=rt("h2","type--ui--text-300"),q=s=>t.jsxs("div",{className:it(s.className,"histogram-section-title"),children:[t.jsx(_t,{children:s.children[0]}),s.children[1]]});try{q.displayName="HistogramSectionTitle",q.__docgenInfo={description:`HistogramSectionTitle is a title element that is displayed above a histogram.
...
| Block time                 10.5s |
|                          Average |
+----------------------------------+`,displayName:"HistogramSectionTitle",props:{className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}}}}}catch{}export{q as H,k as P,E as S,I as a,X as b,K as c,z as d,v as e};
