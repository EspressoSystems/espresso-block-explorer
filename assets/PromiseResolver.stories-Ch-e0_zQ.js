import{j as e,R as c}from"./iframe-BoSgNqBp.js";import{N as p}from"./NotFoundError-B7azoDNK.js";import{n as u}from"./LoadingProvider-CwAifW4j.js";import{C as d}from"./CircularProgressIndicator-DttGafIS.js";import{T as m}from"./Text-BU7JBOLk.js";import{A as g,a as l}from"./ProvideAsyncStates-DNO9ylBI.js";import{P as x}from"./PromiseResolver-BI2JroNS.js";import"./preload-helper-PPVm8Dsz.js";import"./string-Bj9RBsFG.js";import"./assert-BI051aL8.js";import"./MissingElementError-Dm9GiuiL.js";import"./UnimplementedError-DRDLdWuq.js";import"./higher_order-DFRpXnkL.js";async function f(r){return new Promise(a=>{const i=setTimeout(()=>{clearTimeout(i),a()},r)})}const P=()=>{const r=c.useContext(g);if(r.asyncState===l.waiting)return e.jsx(d,{});if(r.error)return e.jsx(m,{text:"Error: "+r.error.toString()});const a=r.data;return e.jsx(m,{text:String(a)})},j=r=>e.jsx(x,{promise:r.promise,children:e.jsx(P,{})}),L={title:"Components/Async/Promise Resolver",component:j},o={args:{promise:f(2e3).then(()=>"Done!")}},s={args:{promise:u}},t={args:{promise:Promise.resolve("Done!")}},n={args:{promise:Promise.reject(new p("nothing"))}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
